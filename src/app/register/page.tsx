...
import { Mail, Lock, User, Phone, Coffee, Eye, EyeOff, ArrowLeft, CheckCircle } from 'lucide-react';
...
function RegisterPageContent() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!isValidPhone(phone)) {
      toast.error('Утасны дугаар буруу байна (8 оронтой)');
      return;
    }
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      toast.success('Google-ээр амжилттай бүртгэгдлээ');
      router.push(redirect);
    } catch {
      toast.error('Google-ээр бүртгүүлэхэд алдаа гарлаа');
    } finally {
  ...
  const benefits = [
    'Бөөний үнээр худалдан авах',
    'Захиалгын түүх харах',
    'Хямдрал, урамшуулал авах',
    'Хурдан захиалга өгөх'
  ];
    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative bg-gradient-to-br from-coffee-600 via-coffee-700 to-coffee-800">
        ...
        <div className="relative z-10 flex flex-col justify-center items-center w-full p-12 text-white">
          ...
          >
            ...
            <p className="text-xl text-coffee-100 max-w-md mb-8">
              Бүртгүүлээд дараах давуу талуудыг эдлээрэй
            </p>
          </motion.div>
          ...
          >
            {benefits.map((benefit, index) => (
              ...
              >
                ...
                <span className="text-lg text-coffee-100">{benefit}</span>
              </motion.div>
            ))}
          </motion.div>
        </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-white overflow-y-auto">
        ...
        >
          ...
          <Link 
            href="/" 
            className="inline-flex items-center text-coffee-500 hover:text-coffee-600 mb-6 transition-colors"
          >
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                <Phone className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-coffee-400" />
                <input
                  type="tel"
            ...
            <div className="flex items-center">
              <button
                ...
                className="text-sm text-coffee-500 hover:text-coffee-600 flex items-center gap-1"
              >
            ...
            <div className="flex items-start gap-2">
              <input 
                type="checkbox" 
                id="terms"
                className="w-4 h-4 mt-1 rounded border-coffee-300 text-coffee-500 focus:ring-coffee-500" 
              />
              <label htmlFor="terms" className="text-sm text-coffee-600">
                Би <Link href="/terms" className="text-coffee-500 hover:underline">үйлчилгээний нөхцөл</Link>-ийг зөвшөөрч байна
              </label>
            </div>
          ...
          <button 
            ...
            className="w-full flex items-center justify-center gap-3 py-3 px-4 rounded-xl border-2 border-coffee-200 hover:border-coffee-300 hover:bg-coffee-50 transition-all text-coffee-700 font-medium disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {googleLoading ? (
              <svg className="animate-spin h-5 w-5 text-coffee-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                <circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4"></circle>
                <path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
              </svg>
            ) : (
          ...
          <p className="mt-6 text-center text-coffee-600">
            Бүртгэлтэй юу?{' '}
            <Link href="/login" className="text-coffee-500 hover:text-coffee-600 font-semibold">
              Нэвтрэх
            </Link>
          </p>
        </motion.div>
